...
import { useListProductTableColumn } from "./useListProductTableColumn"
import { PricedProduct } from "@medusajs/client-types"
import { useListProductTableFilters } from "./useListProductTableFilters"
...
export const ListProductTable = (props: Props) => {
  const location = useLocation()
  const [selectedProducts, setSelectedProducts] = useState<
    NonNullable<PricingGroupFormType["addOnProducts"]>
  >(props.selectedProducts)

  const { paginate, filters, setQuery } = useListProductTableFilters({
          ...
          <div className="flex flex-col">
            <p>
              <span className="text-orange-600">
                {groupedSelectedProductByProductId.length}/{count}
              </span>{" "}
              products selected
            </p>
            <TableContainer
